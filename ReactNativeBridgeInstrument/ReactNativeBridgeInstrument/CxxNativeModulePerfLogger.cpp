...
#include "CxxNativeModulePerfLogger.hpp"
...
void CxxNativeModulePerfLogger::syncMethodCallStart(
  ...
  os_signpost_interval_begin(sync_method_call_logger, OS_SIGNPOST_ID_EXCLUSIVE, function_name(__func__), "module=%s method=%s", moduleName, methodName);
  os_signpost_event_emit(points_of_interest_logger, OS_SIGNPOST_ID_EXCLUSIVE, function_name(__func__), "module=%s method=%s", moduleName, methodName);
...
void CxxNativeModulePerfLogger::syncMethodCallEnd(
                                                    const char *moduleName,
                                                    const char *methodName) {
  os_signpost_interval_end(sync_method_call_logger, OS_SIGNPOST_ID_EXCLUSIVE, function_name(__func__), "module=%s method=%s", moduleName, methodName);
  os_signpost_event_emit(points_of_interest_logger, OS_SIGNPOST_ID_EXCLUSIVE, function_name(__func__), "module=%s method=%s", moduleName, methodName);
};
...
void CxxNativeModulePerfLogger::asyncMethodCallStart(
                                                    const char *moduleName,
                                                    const char *methodName) {
  os_signpost_interval_begin(async_method_call_logger, OS_SIGNPOST_ID_EXCLUSIVE, function_name(__func__), "module=%s method=%s", moduleName, methodName);
  os_signpost_event_emit(points_of_interest_logger, OS_SIGNPOST_ID_EXCLUSIVE, function_name(__func__), "module=%s method=%s", moduleName, methodName);
};
